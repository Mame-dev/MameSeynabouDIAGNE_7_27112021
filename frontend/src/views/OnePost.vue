        ...
        <div class="card card-product mx-auto">
          <div class="card-body product-body">
            ...
            <router-link
              ...
              >Modifier votre post</router-link
            >
          </div>
            ...
            <div class="row d-flex justify-content-center">
              <div class="col-md-10">
                ...
                >
                  ...
                  <button
                    type="submit"
                    class="btn btn-danger signup ml-2"
                    @click="PostComm()"
                  >
                    commenter
                  </button>
                ...
                >
                    ...
                    <div class="user d-flex flex-row align-items-center">
                      <span
                        ><small class="font-weight-bold"
                          ><span class="nametitle">{{ comm.username }} </span> a
                          répondu
                        </small></span
                      >
                    </div>
                  ...
                  >
                    ...
                    <div
                      class="icons align-items-center"
                      v-if="userId == comm.user_id || admin == 1"
                    >
